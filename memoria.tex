...
%codirector, % Uncomment to not load the hyperref package
...
\codirector{Nombre del Codirector (pertenencia)} % El nombre del codirector si lo hubiera, se usa en la carátula y se puede usar el cualquier lugar del documento con el comando \codirname
