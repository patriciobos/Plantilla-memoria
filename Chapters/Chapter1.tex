...
La estructura básica de cualquier documento de \LaTeX{} comienza con la definición de clase del documento, es seguida por un preámbulo donde se pueden agregar funcionalidades con el uso de \texttt{paquetes} (equiparables a bibliotecas de C), y finalmente, termina con el cuerpo del documento, donde irá el contenido de nuestra memoria.
...
\begin{lstlisting}
	...
	\begin{document}	 <- Comienzo del contenido del documento
	Hello world!
	\end{document}
\end{lstlisting}
...
Y cuando se usan se muestran así: \citep{ARTICLE:1}, \citep{BOOK:1}, \citep{BOOK:2}, \citep{WEBSITE:1}.