...
\keyword{Figures} -- Esta carpeta contiene todas las figuras de la memoria.  Estas son las versiones finales de las imágenes que van a ser incluidas en la memoria.  Pueden ser imágenes en formato \textit{raster} como \file{.png}, \file{.jpg} o en formato vectoriales como \file{.pdf}, \file{.ps}.  Se debe notar que utilizar imágenes vectoriales disminuye notablemente el peso del documento final y acelera el tiempo de compilación por lo que es recomendable su utilización siempre que sea posible.
...
Finalmente, en este archivo es donde se incluyen en la complilación los archivos \file{.tex} con los capítulos indiviluales que se encuentran en la carpeta Chapters.  Esto se logra con el siguiente código \LaTeX{}:

\begin{verbatim}
	\include{Chapters/Chapter1}
	\include{Chapters/Chaptr2} 
...
\section{Incorporando su información personalizada en el archivo \file{memoria.tex}}
