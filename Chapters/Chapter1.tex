...
%\begin{figure}[h!]
%	\centering
%	\includegraphics[width=0.7\linewidth]{Figures/SET_132_04}
%	\caption[]{Subestación transformadora 13,2 / 0,4 kV a nivel. Imagen tomada por el autor.}
%	\label{SET_132_04kv}
%\end{figure} \\

%como la que se presenta en la \ref{SET_132_04kv}
...
Llegado el momento de entregar la energía al usuario final, es indispensable cuantificar la misma con el fin de comercializar. Las distribuidoras del servicio utilizan medidores de energía de electromecánicos o electrónicos, que registran en todo momento la energía acumulada que fluye por el mismo.\\
% TODO: \usepackage{graphicx} required
\begin{figure}[h]
	\centering
	\includegraphics[width=0.7\linewidth]{Figures/Medicion_corriente_con_TI}
...
La medición de corriente puede ser directa, vinculando los conductores de alimentación de la carga directamente al medidor o indirecta. Una medición indirecta consiste en reducir los valores de corriente de carga a través de transformadores de corriente (TI) y vinculando sus secundarios a la medición \ref{fig:medicioncorrienteconti}. Este último método se emplea en casos donde la corriente calculada supera el valor permitido por el medidor de energía, por lo que finalmente será necesario multiplicar el valor de la lectura por un coeficiente correspondiente a la relación de transformación del TI.\\  
% TODO: \usepackage{graphicx} required
\begin{figure}[h!]
	\centering
	\includegraphics[width=0.7\linewidth]{Figures/medidor_digital_con_complemento_gsm}
...
\end{figure}
En la actualidad muchas prestadoras del servicio eléctrico han adoptado estrategias de medición inteligente similares a la presentada en la \ref{fig:medidordigitalconcomplementogsm}. En este esquema los equipos de medición se reportan a centros de operación en tiempo semi real a través de una red de comunicaciones movil como por ejemplo GSM.\\
El concepto de telemedición aporta además de lo comercial, valiosa información técnica ya que los centros de operaciones conocen en todo momento el estado del medidor con la posibilidad de detectar fallas o interrupción del servicio eléctrico. Sin embargo, esto conlleva una inversión inicial considerable que muchas empresas no están dispuestas a afrontar o no tienen los recursos suficientes como para implementar, a pesar de tener resultados beneficiosos en lo económico a largo plazo e inmediato en cuanto a calidad del servicio prestado.


\section{Estado del arte y problematica identificada}
En Sudamérica, gran parte de las empresas distibuidoras de energía eléctrica y sus tercerizadas basan parte de sus operaciones en el contacto directo con los usuarios finales mediante reclamos para informar acerca de interrupciones en el servicio de distribución de energía eléctrica. Una vez recibido un reclamo, la prestadora de servicios envía al grupo de operaciones especializado a recorrer el área circundante al cliente y tratar de determinar el motivo de la interrupción del servicio.
% TODO: \usepackage{graphicx} required
\begin{figure}[h!]
	\centering
...
\end{figure}
Un hecho común en el nordeste Argentino y particularmente en la provincia de Misiones es la destrucción de fusibles aéreos como el presentado en la \ref{fig:nh_aereo_bt}. Estos fusible conectados inmediatamente a la salida de baja tension y en serie con las líneas de distribución, cumplen la función de protección por sobrecorriente debido a picos de consumo durante un determinado periodo de tiempo o cortocircuitos causados por desastres naturales como el visto en la \ref{fig:arbolcaidolineabt}. Los fusibles involucrados actúan de manera correcta autodestruyendose e interrumpiendo el paso de corriente.\\
\begin{figure}[h!]
	\centering
...
Las tecnologías emergentes propias de IoT tales como las redes de comunicación de baja potencia y largo alcance LPWAN \citep{rfc8376}, y las redes tipo malla se analizan y comparan en \citep{ARTICLE:4} como las tecnologías disponibles y viables para dotar de una infraestructura de comunicaciones a las redes de distribución metropolitanas. En \citep{ARTICLE:5} y [11] se presentan sistemas de medición de temperatura autónomos utilizando transductores termoeléctricos y electromagnéticos para conversión de energía térmica o electromagnética en energía eléctrica para la alimentar la electrónica involucrada y cargar un acumulador.
