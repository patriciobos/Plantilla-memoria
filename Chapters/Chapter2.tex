...
La decisión de optar por un banco de supercapacitores como reemplazo total de una batería, se basa principalmente en el entorno donde operará el nodo hardware. Las diferencias entre una batería y un SC de interés para este proyecto, son plasmadas en la tabla \ref{tab:batteria_vs_supercap}.\\
...
\begin{figure}[h!]
	...
	\label{fig:dcdcboost}
\end{figure}\\
Su topología interna es \textit{boost} o elevador de tensión. En el hardware del sistema, cumple la función de llevar la tensión variable del SC conectado a su entrada a una fija de 5 V. 
