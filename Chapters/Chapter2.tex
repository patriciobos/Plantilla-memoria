...
\begin{figure}[h!]
	...
	\caption{Diagrama de bloques del firmware implementado en el microcontrolador y su interacción con la red LoRaWAN y los servicios de backend privados del sistema.}
